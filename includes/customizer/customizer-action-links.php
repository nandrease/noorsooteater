...
namespace Noorsooteater\Includes\Customizer;

if ( ! defined( 'ABSPATH' ) ) {
	exit; // Exit if accessed directly.
}

class NOORSOOTEATER_Customizer_Action_Links extends \WP_Customize_Control {
		...
		switch ( $action_link_type ) {
			case 'install-elementor':
				$action_link_data = [
					...
					'alt' => esc_attr__( 'Elementor', 'noorsooteater' ),
					'title' => esc_html__( 'Install Elementor', 'noorsooteater' ),
					'message' => esc_html__( 'Create cross-site header & footer using Elementor.', 'noorsooteater' ),
					'button' => esc_html__( 'Install Elementor', 'noorsooteater' ),
					'link' => wp_nonce_url(
						add_query_arg(
							[
			...
			case 'activate-elementor':
				$action_link_data = [
					'image' => get_template_directory_uri() . '/assets/images/elementor.svg',
					'alt' => esc_attr__( 'Elementor', 'noorsooteater' ),
					'title' => esc_html__( 'Activate Elementor', 'noorsooteater' ),
					'message' => esc_html__( 'Create cross-site header & footer using Elementor.', 'noorsooteater' ),
					'button' => esc_html__( 'Activate Elementor', 'noorsooteater' ),
			...
			case 'activate-header-footer-experiment':
				$action_link_data = [
					'image' => get_template_directory_uri() . '/assets/images/elementor.svg',
					'alt' => esc_attr__( 'Elementor', 'noorsooteater' ),
					'title' => esc_html__( 'Style using Elementor', 'noorsooteater' ),
					'message' => esc_html__( 'Design your cross-site header & footer from Elementor’s "Site Settings" panel.', 'noorsooteater' ),
					'button' => esc_html__( 'Activate header & footer experiment', 'noorsooteater' ),
			...
			case 'style-header-footer':
				$action_link_data = [
					'image' => get_template_directory_uri() . '/assets/images/elementor.svg',
					'alt' => esc_attr__( 'Elementor', 'noorsooteater' ),
					'title' => esc_html__( 'Style cross-site header & footer', 'noorsooteater' ),
					'message' => esc_html__( 'Customize your cross-site header & footer from Elementor’s "Site Settings" panel.', 'noorsooteater' ),
					'button' => esc_html__( 'Start Designing', 'noorsooteater' ),
	...
	private function get_customizer_action_links_html( $data ) {
		...
		return sprintf(
			'<div class="noorsooteater-action-links">
				<img src="%1$s" alt="%2$s">
				<p class="noorsooteater-action-links-title">%3$s</p>
				<p class="noorsooteater-action-links-message">%4$s</p>
